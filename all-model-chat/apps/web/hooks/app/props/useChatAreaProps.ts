...
export const useChatAreaProps = (logic: ReturnType<typeof useAppLogic>) => {
  ...
  return useMemo(() => ({
    ...
    toolMode: chatState.currentChatSettings.toolMode || 'none',
    onSelectToolMode: chatState.selectToolMode,
    enabledMcpServerIds: chatState.currentChatSettings.enabledMcpServerIds || [],
    onToggleMcpServer: chatState.toggleMcpServer,
    mcpSelectionLocked: !!chatState.currentChatSettings.mcpSelectionLocked,
    mcpServers: chatState.mcpServers,
    isMcpEnabled: chatState.isMcpEnabled,
    isMcpStatusLoading: chatState.isMcpLoading,
    mcpStatusError: chatState.mcpError,

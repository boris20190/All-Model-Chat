            ...
            >
                ...
                <main className="flex-1 flex flex-col min-w-0 bg-[var(--theme-bg-primary)] relative overflow-hidden">
                    ...
                    <header className="hidden md:flex items-center px-8 py-6 flex-shrink-0">
                        ...
                        {hasUnsavedChanges && requiresConfirmation && (
                            <span className="ml-3 px-2 py-0.5 text-xs font-medium rounded-full bg-amber-500/20 text-amber-600 dark:text-amber-400 animate-pulse">
                                {t('settingsUnsavedChanges') || 'Unsaved'}
                            </span>
                        )}
                    </header>

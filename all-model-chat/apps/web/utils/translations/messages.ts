...
export const messagesTranslations = {
    ...
    web_grounding_verified: { en: 'Web verified', zh: '已联网检索' },
    web_grounding_missing: { en: 'Web search evidence missing', zh: '未检测到联网搜索证据' },
    web_grounding_counts: { en: 'Q:{queries} C:{chunks} Ref:{citations} U:{urls}', zh: 'Q:{queries} C:{chunks} 引:{citations} U:{urls}' },
    message_mcp_attached: { en: 'MCP attached', zh: 'MCP 已附加' },
    message_mcp_requested: { en: 'MCP requested', zh: 'MCP 已请求' },
    message_mcp_degraded: { en: 'no server attached', zh: '未附加可用服务器' },
    message_mcp_called_count: { en: 'called: {count}', zh: '调用次数: {count}' },
    message_mcp_show_details: { en: 'details', zh: '明细' },
    message_mcp_hide_details: { en: 'hide', zh: '收起' },

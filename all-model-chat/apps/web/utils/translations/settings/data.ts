export const dataSettings = {
    ...
    settingsFilesOverviewUploadLabel: { en: 'Upload Files', zh: '上传文件' },
    settingsFilesOverviewUploadDesc: { en: 'Select local files and upload them to remote storage. They will not be auto-attached to current chat.', zh: '选择本地文件并上传到远程文件库，不会自动加入当前会话。' },
    settingsFilesOverviewUpload: { en: 'Upload', zh: '上传' },
    settingsFilesOverviewUploading: { en: 'Uploading...', zh: '上传中...' },
